...
<body onselectstart="return false">
	...
	<div id="signature-pad" class="signature-pad">
		...
		<div class="signature-pad--footer">
			...
			<div class="signature-pad--actions">
				<div>
					<button class="clear btn btn-secondary mr-2" data-action="clear">ล้าง</button>
					<button type="button" class="button" data-action="change-color" hidden>Change color</button>
					<button type="button" class="button" data-action="undo" hidden>ย้อนกลับ</button>
	...
	<textarea id="h_code" rows="20" cols="100" hidden></textarea>
	<script>
		/*!
	...
	<script>
		...
		function add_signature(dataURL) {
			...
			var URL = '../../process/signature_user.php';
			$.ajax({
				url: URL,
				method: "POST",
				data: {
				...
				success: function(data) {
					window.location.href = '../../index.php?module=sign&action=sign_form&idcard=' + idcard;
				}
			});
