              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <?PHP if ($_list['car_lend_status'] == 0) { 
                    ...
                    $App_Text = "ต้องการอนุมัติการจองรถนี้ใช่หรือไม่ ?";
                    $App_Color = "#1cc88a";
                    $App_Link = "process/update_car_lend.php?status=1&id=" . $_list['car_lend_id'];
      
                    $Un_Title = "ยืนยันการไม่อนุมัติ";
                    $Un_Text = "ต้องการไม่อนุมัติการจองรถนี้ใช่หรือไม่ ?";
                    $Un_Color = "#d33";
                    $Un_Link = "process/update_car_lend.php?status=8&id=" . $_list['car_lend_id'];
                    ?>
