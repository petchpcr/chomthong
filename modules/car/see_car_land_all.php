<div id="wrapper">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div class="container-fluid mb-4">
      ...
      <h1 class="text-center text-truncate h3 mb-4">ประวัติการจองทั้งหมด</h1>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <?PHP
          $sql = "SELECT * FROM tb_car_lend a inner join tb_car b on a.car_id = b.car_id inner join tb_driver d on a.driver_id = d.driver_id order by car_lend_status asc  ";
