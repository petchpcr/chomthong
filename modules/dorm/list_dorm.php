            ...
            <div class="list-single">
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <a href="process/delete.php?table=tb_dorm&ff=dorm_id&id=<?= $_list['dorm_id']; ?>" class="btn btn-sm btn-danger" style="width: 100%; margin-top: 15px" onclick="return confirm('ยืนยันการลบ?');">
