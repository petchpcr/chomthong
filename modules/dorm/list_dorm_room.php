          ...
          <div class="list-single">
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <a href="index.php?module=modal&action=dorm/dorm_room_form&dorm_id=<?= $dorm_id; ?>" class="btn btn-primary" data-remote="false" data-toggle="modal" data-target="#hrefModal" style="width: 100%; margin-top: 10px">
