<div id="wrapper">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div class="container-fluid mb-4">
      ...
      <h1 class="text-center text-truncate h3 mb-4">ประวัติการยืมทั้งหมด</h1>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <?PHP
          $sql = "SELECT * FROM tb_equipment_lend z inner join tb_equipment a on z.equipment_id = a.equipment_id inner join tb_building_room b on a.building_room_id = b.building_room_id inner join tb_building d on b.building_id = d.building_id order by equipment_lend_id desc ";
